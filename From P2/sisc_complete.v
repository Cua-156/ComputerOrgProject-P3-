...
module sisc (clk, rst_f);
  ...
  wire rf_we, wb_sel, br_sel, pc_rst, pc_write, pc_sel, ir_load, c_in;
  wire [3:0] alu_op;
...
// component instantiation
  ...
  initial
  $monitor($time,,"%h  %h  %h  %h  %h  %h  %h  %b  %b  %h  %h",instr,u2.ram_array[1],u2.ram_array[2],u2.ram_array[3],u2.ram_array[4],u2.ram_array[5],alu_op,wb_sel,rf_we,wr_dat,stat);
